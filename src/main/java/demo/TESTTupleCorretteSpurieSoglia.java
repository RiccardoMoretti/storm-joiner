...
public class TESTTupleCorretteSpurieSoglia {
	...
	public static void main(String[] args) throws Exception {
		...
		for ( int i = 0 ; i < NUMTESTCASE ; i++ )			
		{
		     String filename= "C:/Users/Moretti/Dropbox/Università/Tesi/Test/1TupleCorretteSoglia.txt";
		...
		for ( int i = 0 ; i < NUMTESTCASE ; i++ )			
		{
		     String filename= "C:/Users/Moretti/Dropbox/Università/Tesi/Test/1TupleSpurieSoglia.txt";
		     FileWriter fw = new FileWriter(filename,true); //the true will append the new data
